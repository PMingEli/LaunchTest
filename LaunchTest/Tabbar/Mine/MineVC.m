...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor=[UIColor colorWithHexString:@"#dbdbdb" alpha:0.9];
    ...
    self.tabBarItem.image=[[UIImage imageNamed:@"mine"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];//默认图片
    self.tabBarItem.selectedImage=[[UIImage imageNamed:@"mine_s"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];//选中图片
